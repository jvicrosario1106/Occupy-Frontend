...
import { FcExport, FcUp, FcFullTrash, FcUndo } from "react-icons/fc";
...
const Saved = ({ tasks, idDeleteTask, setTasks }) => {
        ...
        actions={
          ...
          userDepartment.role === "Client"
            ? [
                {
                  icon: FcUndo,
                  tooltip: "Back to Done",
                  onClick: (event, rowData) => backToDone(rowData.id, "DONE"),
                },
              ]
            : [
                {
