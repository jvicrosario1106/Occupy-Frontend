...
const ViewCustomerResidentForm = ({ cust, classes }) => {
  ...
  return (
    <div>
      <Title title={`Resident | ${cust.customer.email}`} />
      <Grid
        spacing={3}
        container
      ...
      >
        ...
        <Grid item>
          <form method="post" onSubmit={(e) => onSumbmitCustomerForm(e)}>
...
export default ViewCustomerResidentForm;
